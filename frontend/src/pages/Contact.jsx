      ...
      <div className="px-4 mx-auto max-w-screen-md">
        ...
        <form action="#">
          <div>
            ...
            <input type="email" id="email" placeholder="example@example.com" className="form__input mt-1" required/>
          </div>
          <br/>
          <div>
          ...
          <br/>
          <button className="btn rounded sm:w-fit" type="button">Submit</button>
        </form>
      </div>
    </section>
  )
