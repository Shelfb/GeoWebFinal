          ...
          {[...Array(5).keys()].map((_, index) => {
            ...
            return (
              <button
                ...
                onMouseLeave={() => setHover(0)} // Resetea el hover al salir del área de la estrella
                onDoubleClick={() => {setHover(0); setRating(0);}} // Resetea el rating y hover con doble click
              >
                <span>
                  <AiFillStar />
                </span>
