...
const Profile = ({user}) => {
  ...
  useEffect(() => {
    setFormData({name:user.name, email:user.email, photo:user.photo, place:user.place})
  }, [user]);
    ...
    <div className="mt-10">
      <form onSubmit={submitHandler}>
            <div className="mb-5">
              ...
              required className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer"/>
            </div>
            <div className="mb-5">
              <input type="email" placeholder="Email" name="email" value={formData.email} onChange={handleInputChange}
              aria-readonly readOnly className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer"/>
            </div>
            <div className="mb-5">
            ...
            <div className="mb-5 flex items-center justify-between">
              ...
              <label className='text-headingColor font-bold text-[16px] leading-7'>
                Type of Place: 
                <select name="place" value={formData.place} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'>
                  ...
                  <option value="no-have">I do not have</option>
                </select>
              </label>
            </div>
